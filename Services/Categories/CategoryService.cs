...
namespace Services.Categories
{
    public class CategoryService : ICategoryService
    {
        ...
        public Task<PicCategoryViewModel> GetCategoryForEditPic(int catId, CancellationToken cancellationToken)
        {
            return _mediator.Send(new GetCategoryForEditPicQueries(catId),cancellationToken);
        }

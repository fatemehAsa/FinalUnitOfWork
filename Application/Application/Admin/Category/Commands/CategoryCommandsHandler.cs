        ...
        IRequestHandler<DeleteCategoryCommand, bool>
    {
        ...
        public async Task<bool> Handle(DeleteCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    var imageName = cat.ImageName;
                    var deletePath = Path.Combine(Directory.GetCurrentDirectory(), $"wwwroot/images/img/{imageName}");
                    var thumbpath = Path.Combine(Directory.GetCurrentDirectory(), $"wwwroot/images/thumbs/{imageName}");
